    ...
    <div class="col">
        <div class="card">
            <div class="card-header bg-primary">
                ...
                ?>
                    <a href="#" data-toggle="modal" data-target="#modalpengaduan" class="btn btn-primary"><i class="fas fa-fw fa-solid fa-comment"></i>Tambah Pengaduan</a>
                <?php
                } ?>
            </div>
            <div class="card-body">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                if (!empty(session('level')) && session('level') != 'masyarakat') {
                                    ...
                                    ?>
                                        <a class="btn btn-danger" href="#" data-toggle="modal" data-target="#modaltanggapan" data-pengaduan="<?= $row['id_pengaduan'] ?>" data-aduan="selesai" readonly>Lihat Tanggapan</a>
                                <?php
                                    }
                                }
                                ?>
